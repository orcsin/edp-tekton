...
| file://../common-library | edp-tekton-common-library | 0.3.19 |
...
| tekton.pruner.image | string | `"docker.io/epamedp/kubectl:0.1.1"` | Docker image to run the pruner, expected to have kubectl and jq |
